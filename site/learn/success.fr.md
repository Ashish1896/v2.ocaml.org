...
- Table des matières
  ...
  - [Le synchroniseur de fichiers Unison](#le-synchroniseur-de-fichiers-unison)
  - [Le client pair-à-pair MLdonkey](#le-client-pair-à-pair-mldonkey)
  - [Le Langage de Modélisation Financière de LexiFi](#le-langage-de-modélisation-financière-de-lexifi)
  - [Le système de communication distribuée Ensemble](#le-système-de-communication-distribuée-ensemble)
  - [L'assistant de preuve Coq](#lassistant-de-preuve-coq)
  - [L'analyseur statique ASTRÉE](#lanalyseur-statique-astrée)
  - [SLAM](#slam)
  - [FFTW](#fftw)
...
## Jane Street
[<img src="/img/users/jane-street.jpg" alt="Jane Street" style="clear: left; margin-right: 10px"/>](http://janestreet.com/technology/)
...
[<img src="/img/mldonkey.jpg" alt="Screenshot" title="Screenshot of one of MLdonkey's windows" style="clear: left; margin-right: 10px"/>](/img/mldonkey.jpg)
...
[<img src="/img/coq.jpg" alt="Screenshot" title="Screenshot of Coq's integrated development environment" style="clear: left; margin-right: 10px"/>](/img/coq.jpg)
...
[<img src="https://www.airbus.com/aircraft/previous-generation-aircraft/a340-family.html" alt="A340" title="ASTRÉE has been used to certify the Airbus A340 flight control software" style="clear: left; margin-right: 10px"/>](https://www.airbus.com/aircraft/previous-generation-aircraft/a340-family.html)
...
« À ce jour, ASTRÉE a prouvé l'absence d'erreurs d'exécution dans le logiciel de contrôle primaire de la [famille Airbus A340](https://www.airbus.com/aircraft/previous-generation-aircraft/a340-family.html). Cela serait impossible par de simples tests, car le test ne considère qu'un sous-ensemble limité des cas, tandis que l'interprétation abstraite considère un sur-ensemble de tous les comportements possibles du système. »
...
## FFTW
[<img src="/img/fftw-thumb.png" alt="FFTW" style="clear: left; margin-right: 10px"/>](/img/fftw-thumb.png)

[FFTW](http://www.fftw.org/) est une [très rapide](http://www.fftw.org/benchfft/) librairie C permettant d'effectuer des Transformées de Fourier Discrètes (DFT). Elle emploie un puissant optimiseur symbolique écrit en OCaml qui, étant donné un entier N, produit du code C hautement optimisé pour effectuer des DFTs de taille N. FFTW a reçu en 1999 le [prix Wilkinson](https://en.wikipedia.org/wiki/J._H._Wilkinson_Prize_for_Numerical_Software) pour les logiciels de calcul numérique.
...
## Liquidsoap
[Liquidsoap](https://www.liquidsoap.info/) est clairement bien établie dans l’industrie de la radio (internet). Liquidsoap est bien connu comme un outil avec des capacités uniques, et a beaucoup d’utilisateurs, y compris des grands commerciaux. Il n’est pas développé comme une entreprise, mais des entreprises développent des services ou des logiciels au-dessus de celui-ci. Par exemple, Sourcefabric développe et vend Airtime au-dessus de Liquidsoap.
